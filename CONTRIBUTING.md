...
For detailed structure, see `CLAUDE.md`.
...
This project maintains high standards. For complete details, see the `project-standards` skill in `.claude/skills/project-standards.md`.
...
- [Project Skills](.claude/skills/README.md) - Specialized skills for development
- [CLAUDE.md](CLAUDE.md) - Project overview and phases
- [Standards](.claude/skills/project-standards.md) - Complete standards reference
- [Testing](docs/TESTING.md) - Testing guide (to be created)
